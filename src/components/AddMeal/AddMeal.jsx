...
export default function AddMeal() {
    ...
    return (
        <div className='grid grid-cols-4 md:grid-cols-4 lg:grid-cols-6'>
            <div className=' col-span-4 col-start-2 col-end-3 flex h-fit  w-[340px]  flex-col items-center justify-center gap-3 overflow-hidden p-8 md:col-end-4 lg:col-start-3 lg:p-4 '>
                <div
                    style={{
                    ...
                    className=' flex h-48 w-full items-center justify-center overflow-hidden bg-center bg-no-repeat'
                >
                ...
                <div className='flex justify-between pl-6'>
                    <button
                        ...
                        className='   right-0  mr-2 rounded bg-[#004945] px-6 py-1 text-white'
                    >
                        {t("Back")}
                    </button>
                    <button
